const pixGrid = function() {
	function centerImage(theImage) {
		let myDifX = (window.innerWidth - theImage.width) / 2, myDifY = (window.innerHeight - theImage.height) / 2;
	...
	myNode.addEventListener("click", function(e) {
		if ("IMG" === e.target.tagName) {
			...
			let imageSrc = e.target.src, largeImage = document.createElement("img");
